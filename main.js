	...
	if(newUser.Profession == " ")
	{
		...
		if (currentMonsterHealth <= 0 &&  chosenMonster.Name != "null")
		{
			count = 1;
			...
			while (newUser.EXP >= newUser.MaxEXP)
			{
				...
				writeToTextArea("Next amount of EXP needed to level up is: " + newUser.MaxEXP + "\nHealth is now: " + newUser.MaxHealth + "\nYou levelled up to LVL: " + newUser.Level);
	...
	function engineer()
	{
		newUser.Health = newUser.Health + 20;
